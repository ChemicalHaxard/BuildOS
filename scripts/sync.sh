...
git clone https://$gh:$token@github.com/Los-Ext/device_lavender_recovery $DT_PATH || { echo "ERROR: Failed to Clone the Device Trees!" && exit 1; }
git clone https://$gh:$token@github.com/ImSpiDy/device_xiaomi_sdm660-common device/xiaomi/sdm660-common
